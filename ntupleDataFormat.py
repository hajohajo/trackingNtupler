...
class Event(object):
    ...
    def hitInfo(self):
	"""Returns hitInfo object."""
	return HitInfo(self._tree,'hitInfo')
...
class Track(_Object, _RecoHitAdaptor, _TrackingParticleMatchAdaptor):
    ...
    def hitInfo_Idx(self):
	return self.hitInfo_hitIdx()
...
##########
class HitInfo(_Collection):
    def __init__(self, tree, prefix):
	self._tree=tree
	self._prefix=prefix

    def nHits(self):
        return (getattr(self._tree, self._prefix+"_Chi2").size())

    def Chi2(self):
        return (getattr(self._tree, self._prefix+"_Chi2"))

    def residual_x(self):
	return (getattr(self._tree, self._prefix+"_residual_x"))

    def residual_y(self):
        return (getattr(self._tree, self._prefix+"_residual_y"))

    def pull_x(self):
        return (getattr(self._tree, self._prefix+"_pull_x"))

    def pull_y(self):
	return (getattr(self._tree, self._prefix+"_pull_y"))

    def x(self):
        return (getattr(self._tree, self._prefix+"_x"))

    def y(self):
        return (getattr(self._tree, self._prefix+"_y"))

    def z(self):
        return (getattr(self._tree, self._prefix+"_z"))

    def xx(self):
        return (getattr(self._tree, self._prefix+"_xx"))

    def xy(self):
        return (getattr(self._tree, self._prefix+"_xy"))

    def yy(self):
        return (getattr(self._tree, self._prefix+"_yy"))

    def yz(self):
        return (getattr(self._tree, self._prefix+"_yz"))

    def zz(self):
        return (getattr(self._tree, self._prefix+"_zz"))

    def zx(self):
        return (getattr(self._tree, self._prefix+"_zx"))
